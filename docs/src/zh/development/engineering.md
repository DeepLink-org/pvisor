...
| `just docs-serve` | 构建双语站点一次并在本地提供预览 |
| `just docs-serve-dirty` | 监听源文件、重建双语站点；浏览器需手动刷新 |
| `just docs-build` | 构建静态文档站点 |
| `just examples` | pVisor 产品示例套件 |
| `just dev` | 格式化、lint 和 Rust 测试 |
...
| 笔记 | 读者 | 用途 |
|---|---|---|
| [发布 PolicyVisor](releasing.md) | 维护者 | 版本、trusted-publisher 与稳定发布流程 |
...
支持的行为请从 [pVisor 指南](../guides/index.md) 开始，实现理由见
