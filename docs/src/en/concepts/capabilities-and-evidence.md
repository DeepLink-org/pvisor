...
can describe an execution environment accurately.
...
| Credentials | pass explicit credentials | delivery and observed use; no automatic expiry guarantee |
...
and history, read
[Security and evidence](security-evidence.md).
